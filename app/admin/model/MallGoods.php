...
class MallGoods extends Model
{
    ...
    public function getPicsAttr($value, $row)
    {
        if ($value == '') {
            return [];
        }
    ...
    public function setPicsAttr($value, $row)
    {
    ...
    public function mallmenus()
    {
        return $this->belongsTo(MallMenus::class, 'menu_id', 'id');
    }
}