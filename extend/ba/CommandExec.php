...
class CommandExec
{
    ...
    public function __construct($authentication)
    {
        ...
        $this->command = Config::get('niceadmin.allowed_commands');
    }
    ...
    public function changeTerminalConfig($config = [])
    {
        ...
        $oldPort           = Config::get('niceadmin.install_service_port');
        $oldPackageManager = Config::get('niceadmin.npm_package_manager');
