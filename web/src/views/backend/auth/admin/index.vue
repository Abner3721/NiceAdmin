...
const baTable = new baTableClass(
    new baTableApi(authAdmin),
    {
        column: [
            ...
            { label: t('auth.admin.nickname'), prop: 'nickname', align: 'center', operator: 'LIKE', operatorPlaceholder: t('Fuzzy query'),show:false },
            ...
            { label: t('auth.admin.mailbox'), prop: 'email', align: 'center', operator: 'LIKE',width:220, show:false,operatorPlaceholder: t('Fuzzy query') },
            { label: t('auth.admin.mobile'), prop: 'mobile', align: 'center', operator: 'LIKE',width:120, operatorPlaceholder: t('Fuzzy query') },
            {
            ...
            { label: t('createtime'), prop: 'createtime', align: 'center', render: 'datetime', sortable: 'custom', operator: 'RANGE', width: 180 },
            {
                label: t('state'),
                prop: 'status',
                align: 'center',
