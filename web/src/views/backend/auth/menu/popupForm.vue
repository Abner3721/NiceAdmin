            ...
            >
                ...
                >
                    ...
                    <el-form-item label="设置快捷入口">
                        <el-radio v-model="baTable.form.items!.quick" label="0" :border="true">{{ t('Disable') }}</el-radio>
                        <el-radio v-model="baTable.form.items!.quick" label="1" :border="true">{{ t('Enable') }}</el-radio>
                    </el-form-item>
