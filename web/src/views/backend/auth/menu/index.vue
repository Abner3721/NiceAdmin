...
const baTable = new baTableClass(
    new baTableApi(authMenu),
    {
        ...
        column: [
            ...
            { label: t('auth.menu.Icon'), prop: 'icon', align: 'center', width: '80', render: 'icon', default: 'el-icon-Minus' },
            ...
            { label: t('updatetime'), prop: 'updatetime', align: 'center', width: '180', render: 'datetime' },
            {
                label: t('operate'),
                align: 'center',
                width: '130',
