...
const baTable = new baTableClass(
    new baTableApi(articleMenus),
    {
        expandAll: false,
        dblClickNotEditColumn: [undefined, 'keepalive', 'status'],
        column: [
            { type: 'selection', align: 'center' },
            { label: t('article.menus.title'), prop: 'title', align: 'left' },
            { label: t('article.menus.imgurl'), prop: 'imgurl', align: 'center', render: 'image' },
            { label: t('state'), prop: 'status', align: 'center', width: '80', render: 'switch' },
            { label: t('createtime'), prop: 'createtime', align: 'center', width: '260', render: 'datetime' },
            {
                label: t('operate'),
                align: 'center',
                width: '130',
