...
const baTable = new baTableClass(
    new baTableApi(userUser),
    {
        column: [
            ...
            { label: t('user.user.mobile'), prop: 'mobile', align: 'center', operator: 'LIKE', width:120, operatorPlaceholder: t('Fuzzy query') },
            {
            ...
            { label: t('createtime'), prop: 'createtime', align: 'center', render: 'datetime', sortable: 'custom', operator: 'RANGE', width: 170 },
